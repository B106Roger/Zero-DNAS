...
experiment_name = 'thetas-v5-wot-precalculated-flops11.4-params46.6-layers-it2880-temp3-dec0.065-voc-second-last-line-my'
...
for idx in range(len(last_thetas) // 2):
    for sub_plot in range(2):
        ...
        axs[idx, sub_plot].set_xticklabels(['9', '6', '3', '0'])
