...
def train(hyp, opt, device, tb_writer=None):
    ...
    if rank in [-1, 0]:
        ...
        info = model_info(model.to('cpu'))
        # Write Result File Entry Title
        with open(results_file, 'a') as file:
            file.write(f"{'Epoch':>10s}{'Mem':>10s}{'GIoU':>10s}{'Obj':>10s}{'Cls':>10s}{'Total':>10s}{'Targets':>10}{'ImgSize':>10s}")
            file.write(f"{'P':>10s}{'R':>10s}{'mAP@50':>10s}{'mAP@50:95':>10s}{'Val_GIoU':>10s}{'Val_Obj':>10s}{'Val_Cls':>10s}\n")
            file.write(f"{info['layers']} layers, {info['parameters']:g} parameters, {info['GFLOPS']:g} GFLOPS\n")
        # Strip optimizers
